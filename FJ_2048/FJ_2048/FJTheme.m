...
@interface FJDefaultTheme : NSObject <FJTheme>
@end

@implementation FJDefaultTheme
...
@interface FJVibrantTheme : NSObject <FJTheme>
@end

@implementation FJVibrantTheme
...
@interface FJJoyfulTheme : NSObject <FJTheme>
@end

@implementation FJJoyfulTheme
...
@implementation FJTheme

+ (Class)themeClassForType:(NSInteger)type {
    switch (type) {
        case 1:
            return [FJVibrantTheme class];
        case 2:
            return [FJJoyfulTheme class];
        default:
            return [FJDefaultTheme class];
    }
}
